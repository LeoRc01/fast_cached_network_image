...
enum ImageExtension {
  ...
  factory ImageExtension.fromPath(String path) =>
      values.firstWhere((element) => path.endsWith('.${element.name}'),
          orElse: () => ImageExtension.png);
}
...
class _FastCachedImageState extends State<FastCachedImage>
  ...
  Widget _buildImageWidget() {
    switch (ImageExtension.fromPath(widget.url)) {
